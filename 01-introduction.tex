...
A popular example is that sparse coding of natural images
produces oriented filters that resemble receptive fields of
simple cells in visual cortex \cite{OlshausenField1996}
(although this notion has been questioned; see Section ``Model limitation'').}
...
This introduces the possibility that \ac{NSC} might \revise{apply elsewhere in the brain}.
% be 
