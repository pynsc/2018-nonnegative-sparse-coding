...
\krisNote{To me, it doesn't make sense when taken with the previous sentence; particularly the word 'other' in the last sentence.}
\mikeNote{Should we just cut it?}
% be 
