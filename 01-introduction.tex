...
\revise{One of the fundamental challenges that brains face 
is to extract relevant information from high-dimensional external stimuli
...
\mikeNote{I agree, will revise. This para already confuses sparse activity (few neurons active) with sparse coding.}
\emilyNote{Can we move the bulk of this to the 'Potential mechanisms' section? That seems to resolve your issue of having just one paragraph about it, to me. We can introduce it and justify it there.}
...
\mikeNote{I feel like R1 will not get the subtle difference between stimulus space and input space. Stimuli are inputs. Plus the rant was on representations, which is still in there... Need some good terminology here...}
\emilyNote{It seems impossible to not talk about representations, but also, couldn't you still need to represent stuff about the world in order to act on it? I think we just need to do a better job of tying representations to actions...}
a process known as
