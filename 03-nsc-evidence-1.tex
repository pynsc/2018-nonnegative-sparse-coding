...
the ability of neurons to perform coordinate transformations 
in posterior parietal cortex
\cite{PougetSejnowski1997,PougetSnyder2000},
...
%  	\revise{Gustatory cortex} & ? & X & \cite{smith2008central,lemon2007,carleton2010} & ? & ? \\    
    ...
    %{\cite{GrazianoAflalo2007,Turner2000}} 
    ...
    Basal ganglia & X & ? & %\revise{?} \pbox{5cm}
    \cite{BarGad2000}
