...
\emilyNote{this section is in the discussion too. should it be deleted here?}
...
\emilyNote{The figure from Fusi might go well somewhere around here, wherever we talk about the efficiency of mixed selectivity. (see Fusi_etal_2016_mixedSelectivity.jpg in artwork folder)}
...
\revise{We should definitely talk about this, too: http://www.pnas.org/content/112/32/10032.long
Topology and connectivity in the mouse brain showed hub nodes that do not obey energy minimization constraints. The authors say: "We propose that the mouse brain network is selected by simultaneous competitive pressures for wiring-cost minimization and hub-mediated information exchange between network modules. High-participation hubs are expensive but central to global integration of information and, thus, essential for adaptive “higher order” brain functions."}
...
\emilyNote{Added to supplementary.}
