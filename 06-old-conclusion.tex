...
\mikeNote{Do we even need the Conclusions? Most of this stuff has been said. We're just repeating ourselves. Repeatedly.}
...
implying that \ac{NSC} is \revise{one of the coding scheme that is}
being applied throughout the brain.
\revise{In addition, \ac{NSC} might provide a useful theoretical framework
...
We offer two testable predictions \revise{for future theoretical and empirical studies}:
...
% \mikeNote{Do we need to scale this back?}
