...
to form the spike-triggered stimulus ensemble (STA; Fig.~\ref{fig:NMF|retina}A).
\Ac{STNMF} then decomposed the ensemble of effective spike-triggered stimuli into
a matrix \textbf{V} containing a set of modules
...
because the spike-eliciting stimuli will have essential statistical
...
(leading to as long-term depression, or LTD).
