...
\cite{Barbieri2015}.
\revise{However, please note that this apparent sparsity might have simply been caused
by presenting a limited set of stimuli (see Section ``Model limitations'').}
...
sparse population activity does not necessarily imply that a brain areas
