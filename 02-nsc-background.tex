...
much like the intuitive notion of combining parts to form a whole. The representations resulting from this model closely resembled visualizations of receptive fields in V1 and other cortical areas, suggesting that parts-based representations are employed in cortex. Although inhibitory connections can possibly be interpreted as a way for parts to cancel, this does not equate to negative coding. In Hoyer's model, he interpreted some weights as E-E connections and others as I-E connections, but all were restricted to a nonnegative domain. \emilyNote{parts-based representations are "better" because they can more closely describe cortical representations}
\emilyNote{from Mike: "- Inhibition is not negative coding. The negative sign of inhibitory weights is not part of W. So Hoyer interpreted the first half of weights in W as E->E and the second as I->E, but all the synaptic weights therein were nonnegative." There's probably a better way to work this into the paragraph}

\jeffNote{Why is parts-based better or more plausible than lateral inhibition that could ``cancel each other out''?}
