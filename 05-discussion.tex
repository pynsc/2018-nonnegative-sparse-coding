...
\revise{First,}
\mikeNote{Added this one}
\revise{we suggest that a variety of neuronal response properties
...
\revise{Second,} we predict that parts-based representations can explain
...
\revise{Third,} where such representations occur, we expect the resulting
...
\mikeNote{My bad, that was a leap - fixed it.}
